...
After standardization, the values of MSE and R squared are approximately the same with those generated by the linear regression model without standardization. The training MSE is `0.442836447539973` and the testing MSE is `0.44375982938707115`. The training R squared is `0.735806256433555` and the testing value is `0.7349959689721618`. We can see a slight drop in the testing value after standardization, but it's only minimal. However, we can see more changes in the coefficients of the standardized model. 
